    ...
    const deleteBalita = (balita) => {
        Swal.fire({
            ...
            customClass: {
                ...
                confirmButton:
                    "bg-rose-600 text-white px-8 py-3 rounded-xl font-black mx-2 hover:bg-rose-700 transition-all",
                cancelButton:
                    "bg-slate-100 text-slate-500 px-8 py-3 rounded-xl font-black mx-2 hover:bg-slate-200 transition-all",
            },
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 bg-white/80 backdrop-blur-md p-6 rounded-[2.5rem] border border-white shadow-xl shadow-slate-200/50">
                    ...
                    <div className="flex flex-col md:flex-row w-full md:w-auto gap-4">
                        <div className="relative group">
                            <Search
                                className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-pink-500 transition-colors"
                                size={18}
                            />
                            <input
                                type="text"
                                        ...
                                        >
                                            ...
                                            <td className="px-10 py-6">
                                                <div className="flex items-center gap-5">
                                                    <div
                                                        className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-inner transition-transform group-hover:scale-110 ${item.jenis_kelamin === "L" ? "bg-blue-50 text-blue-500" : "bg-pink-50 text-pink-500"}`}
                                                    >
                                                        {item.jenis_kelamin ===
                                                        "L" ? (
                                                            <Mars
                                                    ...
                                                    <div>
                                                        ...
                                                        <Link
                                                            ...
                                                            className="text-[13px] font-black text-slate-800 uppercase tracking-tight hover:text-pink-600 transition-colors"
                                                        >
                                                            {item.nama_balita}
                                                        </Link>
                                                        <br />
                                            ...
                                            {/* Alamat & Ibu */}
                                            <td className="px-6 py-6">
                                                <p className="text-[11px] font-black text-slate-800 leading-none mb-1.5 uppercase">
                                                    Bunda {item.nama_ibu}
                                                </p>
                                    ...
                                    <tr>
                                        ...
                                        >
                                            <div className="flex flex-col items-center opacity-30">
                                                ...
                                                <p className="font-black tracking-[0.3em] uppercase text-xs text-slate-500">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            {balitas.links.map((link, key) => {
                                ...
                                return link.url === null ? (
                                    <div
                                        key={key}
                                        className="px-4 py-2 text-[10px] font-black text-slate-300 bg-white border border-slate-100 rounded-xl opacity-50 cursor-not-allowed"
                                    >
                                        {cleanLabel}
                                    </div>
                                ) : (
